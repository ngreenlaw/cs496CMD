...
room7 = {
	...
	"descMod": "",
	"descS": "",
	"features": ["sculpture of cat", "mirror spider"],
	"items": ["sculpture of cat"],
	"visited": "False",
	"north_room": "",
...
room8 = {
	...
	"items": ["explorer's journal", "elephant tusk"],
	"visited": "False",
...
room9 = {
	...
	"descMod": "",
	"descS": "",
	"features": ["food spider", "scarab sculpture"],
	"items": ["scarab sculpture"],
	"visited": "False",
	"north_room": "",
...
room11 = {
	...
	"features": ["set", "ra", "isis", "adventurer", "weapons rack"],
	"items": ["sword", "spear"],
	"visited": "False",
...
room13 = {
	...
	"features": ["writings", "jackal","chimera"],
...
room14 = {
	...
	"descMod": "",
	"descS": "As you enter the room, you see a sphinx statue on the east wall. The sphinx is massive and takes up the majority of the room and scattered around it are tons of jeweled beetles.",
	"features": ["sphinx", "jeweled beetles"],
	"items": [],
	"visited": "False",
	"north_room": "",
	"south_room": "",
